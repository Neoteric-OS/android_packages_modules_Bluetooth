...
public class PhonePolicy implements AdapterService.BluetoothStateCallback {
    ...
    void autoConnectProfilesDelayed() {
        String log = "autoConnectProfilesDelayed(): ";
    ...
    private void connectOtherProfile(BluetoothDevice device) {
        ...
        Log.d(TAG, log + "connectOtherProfile: isConnectTimeoutDelayApplicable is "
               + isConnectTimeoutDelayApplicable);
        Log.d(TAG, log + "connectOtherProfile: isConnectReducedTimeoutDelayApplicable is "
               + isConnectReducedTimeoutDelayApplicable);
        Duration delay;
        if (isConnectTimeoutDelayApplicable)
          delay = CONNECT_OTHER_PROFILES_TIMEOUT_DELAYED;
        else if (isConnectReducedTimeoutDelayApplicable)
          delay = CONNECT_OTHER_PROFILES_REDUCED_TIMEOUT_DELAYED;
        else
          delay = CONNECT_OTHER_PROFILES_TIMEOUT;
