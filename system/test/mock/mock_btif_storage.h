...
struct btif_storage_get_enc_key_material_length {
  ...
  std::function<size_t(const RawAddress* remote_bd_addr)> body{
          [](const RawAddress* /* remote_bd_addr */) { return return_value; }};
  size_t operator()(const RawAddress* remote_bd_addr) { return body(remote_bd_addr); }
};
extern struct btif_storage_get_enc_key_material_length btif_storage_get_enc_key_material_length;
...
struct btif_storage_get_enc_key_material {
  static bt_status_t return_value;
  std::function<bt_status_t(const RawAddress* remote_bd_addr, uint8_t* key_value,
                            size_t* key_length)>
          body{[](const RawAddress* /* remote_bd_addr */, uint8_t* /*key_value */,
                  size_t* /* key_length */) { return return_value; }};
  bt_status_t operator()(const RawAddress* remote_bd_addr, uint8_t* key_value, size_t* key_length) {
