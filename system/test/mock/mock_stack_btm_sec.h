...
struct btm_sec_is_a_bonded_dev_by_transport {
  ...
  std::function<bool(const RawAddress& bda, tBT_TRANSPORT transport)> body{
          [](const RawAddress& /* bda */, tBT_TRANSPORT /* transport */) { return return_value; }};
  bool operator()(const RawAddress& bda, tBT_TRANSPORT transport) { return body(bda, transport); }
};
extern struct btm_sec_is_a_bonded_dev_by_transport btm_sec_is_a_bonded_dev_by_transport;
