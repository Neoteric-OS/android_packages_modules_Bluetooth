...
typedef enum {
  ...
  OI_BLST_ACKNOWLDGE_TIMEOUT = 2802, /**< BLST: Timeout expired while waiting for event
  ...
  OI_AVRCP_RESPONSE_PACKET_OVERFLOW = 3304,     /**< AVRCP: The response message does not fir in one
